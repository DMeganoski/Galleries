...
class GalleryCategoryModel extends Gdn_Model {
	...
	public function RemoveCategory($CategoryID) {
		...
		$this->SQL->Delete("GalleryCategory", array('CategoryKey' => $CategoryID));

	}

	/**
	 *	TODO: Function for generating the home category for a new class
	 * @param type $ClassID
	 */
	public function GenerateHome($ClassID) {

		// insert new category
		$this->SQL->Insert('GalleryCategory', array(
			'CategoryLabel' => 'home',
			'ClassKey' => $ClassID
		));
